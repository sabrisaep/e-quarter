...
<div class="row mt-4">
    <div class="col-md-4">
        <div class="card h-100 shadow-sm">
            ...
            <div class="card-body">
                ...
                <p><strong>Peranan:</strong><br><?= PENGGUNA[esc($pengguna->role)] ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card h-100 shadow-sm h-100">
            ...
            <div class="card-body">
                <form action="<?= base_url('kerani/profil/kemaskini') ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="mb-3">
    ...
    <div class="col-md-4">
        <div class="card h-100 shadow-sm h-100">
            ...
            <div class="card-body">
                <form id="formTukarPassword" action="<?= base_url('kerani/profil/tukar-password') ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="mb-3">
